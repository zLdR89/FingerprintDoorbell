...
private:
  ...
  bool actionConfirmedReset = true;
...
public:
  ...
  void setActionConfirmed(bool state);
  ...
  void configTouchRingActive(uint8_t color, uint8_t sequence, uint8_t scanColor, uint8_t matchColor, uint8_t actionColor);
  bool deleteAll();
